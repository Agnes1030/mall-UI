...
/**********************商品提示************************************/
	...
	$(".proIntro .smallImg img").click(function(){
		...
		//小弹框和详情页图片大小不一样
		$(this).parents(".proCon").find('.proImg').children(".det").attr("src",offset).css({'width':'300px','height':'300px'});
	...
	$(".smallImg > img").mouseover(function(){
		...
		$(this).parent().siblings(".det").attr("src",src).css({'width':'300px','height':'300px'});
